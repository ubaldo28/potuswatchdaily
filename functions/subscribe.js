...
#outlook a { padding:0; }
.ReadMsgBody { width:100%; background-color:#0a0a0a!important; }
.ExternalClass { width:100%; background-color:#0a0a0a!important; }
@media only screen {
...
<table width="600" border="0" cellpadding="0" cellspacing="0" bgcolor="#0a0a0a" style="max-width:600px;width:100%;background-color:#0a0a0a">
  ...
  <tr><td bgcolor="#111111" style="background-color:#111111;padding:28px 36px 24px;border-bottom:1px solid #1e1e1e">
    <div style="font-family:Georgia,'Times New Roman',serif;font-size:24px;font-weight:900;color:#ffffff;letter-spacing:-0.5px">POTUS <span style="color:#cc0000">Watch</span> Daily</div>
  ...
  <!-- Divider -->
  <tr><td bgcolor="#111111" style="background-color:#111111;padding:0 36px"><table width="100%" border="0" cellpadding="0" cellspacing="0"><tr><td style="border-top:1px solid #1e1e1e;font-size:0;line-height:0">&nbsp;</td></tr></table></td></tr>

  <!-- What to expect -->
  <tr><td bgcolor="#111111" style="background-color:#111111;padding:28px 36px 32px">
    <div style="font-size:10px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#555555;margin-bottom:18px;font-family:Arial,Helvetica,sans-serif">What to expect</div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#111111" style="background-color:#111111;vertical-align:top;width:50%;padding-bottom:14px;padding-right:10px;border-left:2px solid #cc0000;padding-left:12px">
          <div style="font-size:13px;font-weight:700;color:#ffffff;margin-bottom:4px;font-family:Arial,Helvetica,sans-serif">Sent every Thursday</div>
          <div style="font-size:12px;color:#666666;line-height:1.6;font-family:Arial,Helvetica,sans-serif">One short email covering the week's most important stories.</div>
        </td>
        <td bgcolor="#111111" style="background-color:#111111;vertical-align:top;width:50%;padding-bottom:14px;padding-left:10px;border-left:2px solid #cc0000;padding-left:12px">
          <div style="font-size:13px;font-weight:700;color:#ffffff;margin-bottom:4px;font-family:Arial,Helvetica,sans-serif">Real analysis</div>
          <div style="font-size:12px;color:#666666;line-height:1.6;font-family:Arial,Helvetica,sans-serif">What happened, the context behind it, and what it likely means.</div>
        </td>
      </tr>
      <tr>
        <td bgcolor="#111111" style="background-color:#111111;vertical-align:top;width:50%;padding-right:10px;border-left:2px solid #cc0000;padding-left:12px">
          <div style="font-size:13px;font-weight:700;color:#ffffff;margin-bottom:4px;font-family:Arial,Helvetica,sans-serif">Short and readable</div>
          <div style="font-size:12px;color:#666666;line-height:1.6;font-family:Arial,Helvetica,sans-serif">Under ten minutes. No padding.</div>
        </td>
        <td bgcolor="#111111" style="background-color:#111111;vertical-align:top;width:50%;padding-left:10px;border-left:2px solid #cc0000;padding-left:12px">
          <div style="font-size:13px;font-weight:700;color:#ffffff;margin-bottom:4px;font-family:Arial,Helvetica,sans-serif">Free</div>
          <div style="font-size:12px;color:#666666;line-height:1.6;font-family:Arial,Helvetica,sans-serif">No tiers, no credit card, nothing to upgrade.</div>
        </td>
      </tr>
    </table>
  </td></tr>
  ...
  <tr><td bgcolor="#0d0d0d" style="background-color:#0d0d0d;padding:22px 36px;border-top:1px solid #1a1a1a;text-align:center">
    <div style="font-size:11px;color:#444444;margin-bottom:7px;font-family:Arial,Helvetica,sans-serif">
      ...
      <a href="https://www.potuswatchdaily.com/about.html" style="color:#555555;text-decoration:none">About</a> &nbsp;&middot;&nbsp;
      <a href="https://www.potuswatchdaily.com/privacy.html" style="color:#555555;text-decoration:none">Privacy</a>
    </div>
