...
async function generateArticles(){
  try{
    ...
    const prompt='You are a senior foreign policy correspondent at POTUS Watch Daily. Write a '+articleType+' on the '+region+' portfolio.\n\nHeadlines:\n'+newsContext+'\n\nStructure (use ## for section headings):\n## [Context heading]\nPara 1: Powerful lede + background context\n\n## [Strategic heading]\nPara 2: Strategic analysis and key dynamics\n\n## [Implications heading]\nPara 3: Wider regional or global implications\n\n## Washington Angle\nPara 4: White House or Congressional dimension\n\n## Outlook\nPara 5: 48-72 hour outlook and what to watch\n\nRules: Title maximum 8 words. No colons in title. Active voice. No rhetorical questions. Section headings must be short (3-5 words), descriptive, and unique. Focus on POLICY, DIPLOMACY, ECONOMICS and STRATEGY. Maintain an analytical tone. Use precise factual language. Never sensationalize or glorify violence.\n\nRespond ONLY with valid JSON no markdown:\n{"title":"max 8 word title","region":"'+region+'","excerpt":"one sentence max 25 words","meta_description":"max 155 chars","slug":"url-slug-no-years-no-dates","body":"## Heading One\\n\\nparagraph text\\n\\n## Heading Two\\n\\nparagraph text\\n\\n## Heading Three\\n\\nparagraph text\\n\\n## Washington Angle\\n\\nparagraph text\\n\\n## Outlook\\n\\nparagraph text"}';
    ...
    await supabase.from('articles').insert({
      ...
      // Affiliate text rendered in a separate disclosure block by api/article.js — not embedded in body.
